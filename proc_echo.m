...
distance = coords / fd * c; % вычисление дистанции до бликов

phi = angle(sr(coords)) - angle(sl(coords)); % вычисление разности фаз между каналачами
phi = angle( exp( 1i*phi ) ); % перевод в действительные занчения
ku = asind(phi*c/(2*pi*fs*d)); % вычисление угла на котором находится объект относительно антенны

blinks = [distance; ku]; % вывод из функции массива [массив дистаций до бликов, массив азимутов бликов]
