...
dphi = max(blinks(2,:)) - min(blinks(2,:)); % вычисление угловой ширины объекта

params = [len, width, dphi]; % вывод из функции массива [длина обекта, ширина объекта, угловая ширина]
